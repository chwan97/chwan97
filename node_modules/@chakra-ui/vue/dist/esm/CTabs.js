...
import { R as createStyledAttrsMixin, M as isDef, J as useId, u as useVariantColorWarning, C as cleanChildren, A as cloneVNodeElement } from './index-4e48fa90.js';
...
var CTabList = {
  ...
  render: function render(h) {
    ...
    var onChangeTab = ref.onChangeTab;
    var orientation = ref.orientation;
    var validChildren = cleanChildren(this.$slots.default);
...
var CTab = {
  name: 'CTab',
  mixins: [createStyledAttrsMixin('CTab')],
  inject: ['$TabContext'],
  props: {
    isSelected: Boolean,
    isDisabled: Boolean,
...
export { CTab, CTabList, CTabPanel, CTabPanels, CTabs };
